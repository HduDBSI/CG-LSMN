...
public class ExtractNames {
     ...
     */
    private static final String rootPath = "/home/yqx/Documents/my-FeatureEnvy-dataset/SourceCode/mai-swe/a";
    ...
    private static void write_txt(){
        ...
        try{
            ...
            // write class names
            printWriter.print("class names:\n");
            for(String s: classNames)
                printWriter.print(s + '\n');
            printWriter.print('\n');

            // write member variable names
            printWriter.print("member variable names:\n");
            for(String s: memberNames)
                printWriter.print(s + '\n');
            printWriter.print('\n');

            // write method names
            printWriter.print("method names:\n");
            for(String s: methodNames)
                printWriter.print(s + '\n');
            printWriter.print('\n');

            // write parameter names
            printWriter.print("parameter names:\n");
            for(String s: argNames)
                printWriter.print(s + '\n');
            printWriter.print('\n');

            // write local variable names
            printWriter.print("variable names:\n");
            for(String s: varNames)
                printWriter.print(s + '\n');
            printWriter.print('\n');

            // write comments in the method
            printWriter.print("comments in the method:\n");
