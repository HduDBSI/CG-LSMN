...
class crossGraphLocalMatch_ablation_text_type(nn.Module):
    def __init__(self, vocabSize, hidden, in_features, out_features, class_num, dropout, alpha):
        super(crossGraphLocalMatch_ablation_text_type, self).__init__()
    ...
    def forward(self, h1_index, edge_index1, h2_index, edge_index2):
        ...
        fusionOut = self.fusionBiLSTM(torch.stack([textInfo,typeInfo], dim=0))
