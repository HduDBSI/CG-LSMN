...
from models.cross_graph_local_match__no_cross_attention import crossGraphLocalMatch
...
if __name__ == '__main__':
    ...
    for task in range(1,2):
        if task == 1:
            ...
            test_result = saveModelPath + '/result_ours_no_att.txt'
        elif task == 2:
            ...
            newLabelPath = codaDataPath + "new_labels.txt"
            saveModelPath = codaDataPath + 'saveModels'
            test_result = saveModelPath + '/result_ours_no_att_m.txt'
